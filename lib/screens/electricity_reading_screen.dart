...
class ElectricityReadingScreen extends StatelessWidget {
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  CurrencyFormatter.formatEuroWithSeparator(
                                    controller
                                        .settings
                                        .value!
                                        .defaultPricePerKw,
            ...
            child: Obx(() {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final totalWithVAT = controller.calculateTotalWithVAT(
                    reading.totalCost,
                  );
                  ...
                  return GestureDetector(
                    onDoubleTap: () =>
                        _showDeleteDialog(context, controller, reading.id),
                    child: Container(
  ...
  void _showDeleteDialog(
    ...
    ElectricityController controller,
    int id,
  ) {
    UiUtils.showConfirmDialog(
      title: 'Excluir leitura?',
      message: 'Tem a certeza que deseja excluir esta leitura?',
      confirmLabel: 'Excluir',
      icon: Icons.delete_outline,
      color: Theme.of(context).colorScheme.error,
      onConfirm: () => controller.deleteReading(id),
    );
  }
}
